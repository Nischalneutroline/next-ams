...
const MobileSidebar = (props: SideBarProps) => {
  ...
  return (
    <div className="absolute top-[12px] left-[20px] h-[calc(100vh-20px)] max-w-[60px] bg-[#FFFFFF] text-gray-600 rounded-[24px] shadow-lg px-8 py-8 flex flex-col gap-20 z-[10]">
